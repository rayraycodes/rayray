...
class __TwigTemplate_03183be5a23e07891b17ffb4932a8800 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 16
        $context["classes"] = ["media", ("media--type-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source,         // line 18
($context["media"] ?? null), "bundle", [], "method", false, false, true, 18), 18, $this->source))), (( !twig_get_attribute($this->env, $this->source,         // line 19
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["media", "view_mode", "attributes", "title_suffix", "content"]);    }
    ...
    {
        return new Source("", "core/profiles/demo_umami/themes/umami/templates/classy/content/media.html.twig", "/Users/rayheyheygun/Desktop/drupal/web/core/profiles/demo_umami/themes/umami/templates/classy/content/media.html.twig");
    }
