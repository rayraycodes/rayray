...
class __TwigTemplate_137a765d09337498845a49ed1b796882 extends Template
{
    private $source;
    private $macros = [];
...
($context["is_active"] ?? null)) ? ("js-active-tab") : (""))];
  ...
  ";
        ...
        if ((($context["is_active"] ?? null) && (($context["level"] ?? null) == "primary"))) {
            // line 29
            echo "    <button class=\"reset-appearance tabs__trigger\" type=\"button\" aria-label=\"";
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/navigation/menu-local-task.html.twig", "/Users/rayheyheygun/Desktop/drupal/web/core/themes/claro/templates/navigation/menu-local-task.html.twig");
    }
