...
class __TwigTemplate_8d64a37aa8ce904fb48393c67221d577 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["title"] ?? null)) {
            // line 17
            echo "  <h1";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["title_attributes"] ?? null), "addClass", ["page-title"], "method", false, false, true, 17), 17, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/classy/content/page-title.html.twig", "/Users/rayheyheygun/Desktop/drupal/web/core/themes/claro/templates/classy/content/page-title.html.twig");
    }
